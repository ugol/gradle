...
public class TestNGTestFramework implements TestFramework {
    ...
    public WorkerTestClassProcessorFactory getProcessorFactory() {
        ...
        return new TestClassProcessorFactoryImpl(testTask.getTestReportDir(), options, suiteFiles, testTask.getTestResultsDir());
    }
    ...
    public void report() {
        // TODO currently reports generated by TestNG are create anyway (unless someone configured the defaultTestListeners=false)
    ...
    private static class TestClassProcessorFactoryImpl implements WorkerTestClassProcessorFactory, Serializable {
        ...
        public TestClassProcessorFactoryImpl(File testReportDir, TestNGOptions options, List<File> suiteFiles, File testResultsDir) {
